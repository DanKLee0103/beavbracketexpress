...
app.put('/api/tournaments/:id', (req, res) => {
  ...
  //Ensure tabs exist and add the new tab
  // if (!tournament.tabs) {
  //   tournament.tabs = [];
  // }
...
// app.get('/api/tournaments/:id/:tabname', (req, res) => {
...
//   // Find the tab by tabname
//   const tab = tournament.tabs.find(tab => tab.name === tabname);

//   if (!tab) {
//     return res.status(404).json({ message: `Tab "${tabname}" not found` });
//   }

//   // Respond with the tab data
//   res.json(tab);
// });

// //Update data for specific tab
// app.put('/api/tournaments/:id/:tabname', (req, res) => {
//   const tournament = tournaments.find(tour => tour.id === req.params.id);
//   if (!tournament) {
//     return res.status(404).json({ message: 'Tournament not found' });
//   }
//   //Update the specific tab data
//   tournament.tabs[req.params.tabname] = req.body;
//   writeDataToFile(tournaments);
//   res.status(200).json({ message: 'Tab updated successfully' });
// });
