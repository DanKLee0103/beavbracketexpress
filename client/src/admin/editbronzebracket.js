...
function EditBronzeBracket() {
  ...
  return (
    <div>
      <h1>{tournament.name} - Bronze Bracket</h1>
      {tournament.bronzeBracket && <MakeBracket data={tournament.bronzeBracket} onUpdate={updateBracketData} />}
...
export default EditBronzeBracket;